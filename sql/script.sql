 ...
 */
-- Insert FC Barcelona
INSERT INTO players (player_id, last_name, name, number, position, team_id) VALUES (nextval('hibernate_sequence'), 'Messi', 'Lionel', 10, 'Delantero', 11);
INSERT INTO players (player_id, last_name, name, number, position, team_id) VALUES (nextval('hibernate_sequence'), 'Suarez', 'Luis', 9, 'Delantero', 11);
INSERT INTO players (player_id, last_name, name, number, position, team_id) VALUES (nextval('hibernate_sequence'), 'da Silva', 'Neymar', 11, 'Delantero', 11);
INSERT INTO players (player_id, last_name, name, number, position, team_id) VALUES (nextval('hibernate_sequence'), 'Stegen', 'Ter', 1, 'Portero', 11);
INSERT INTO players (player_id, last_name, name, number, position, team_id) VALUES (nextval('hibernate_sequence'), 'Rakitic', 'Ivan', 4, 'Centrocampista', 11);
INSERT INTO players (player_id, last_name, name, number, position, team_id) VALUES (nextval('hibernate_sequence'), 'Busquets', 'Sergio', 5, 'Centrocampista', 11);
INSERT INTO players (player_id, last_name, name, number, position, team_id) VALUES (nextval('hibernate_sequence'), 'Gomes', 'Andres', 21, 'Centrocampista', 11);
INSERT INTO players (player_id, last_name, name, number, position, team_id) VALUES (nextval('hibernate_sequence'), 'Piqué', 'Gerard', 3, 'Defensa', 11);
INSERT INTO players (player_id, last_name, name, number, position, team_id) VALUES (nextval('hibernate_sequence'), 'Alba', 'Jordi', 18, 'Defensa', 11);
INSERT INTO players (player_id, last_name, name, number, position, team_id) VALUES (nextval('hibernate_sequence'), 'Macherano', 'Javier', 14, 'Defensa', 11);
INSERT INTO players (player_id, last_name, name, number, position, team_id) VALUES (nextval('hibernate_sequence'), 'Roberto', 'Sergi', 20, 'Defensa', 11);
COMMIT ;

-- Insert Real Madrid
INSERT INTO players (player_id, last_name, name, number, position, team_id) VALUES (nextval('hibernate_sequence'), 'Navas', 'Keylor', 1, 'Portero', 10);
INSERT INTO players (player_id, last_name, name, number, position, team_id) VALUES (nextval('hibernate_sequence'), 'Carvajal', 'Daniel', 2, 'Defensa', 10);
INSERT INTO players (player_id, last_name, name, number, position, team_id) VALUES (nextval('hibernate_sequence'), 'Ramos', 'Sergio', 4, 'Defensa', 10);
INSERT INTO players (player_id, last_name, name, number, position, team_id) VALUES (nextval('hibernate_sequence'), 'Varane', 'Raphael', 5, 'Defensa', 10);
INSERT INTO players (player_id, last_name, name, number, position, team_id) VALUES (nextval('hibernate_sequence'), 'Ronaldo', 'Cristiano', 7, 'Delantero', 10);
INSERT INTO players (player_id, last_name, name, number, position, team_id) VALUES (nextval('hibernate_sequence'), 'Benzema', 'Karin', 9, 'Delantero', 10);
INSERT INTO players (player_id, last_name, name, number, position, team_id) VALUES (nextval('hibernate_sequence'), 'Vieira', 'Marcelo', 12, 'Defensa', 10);
INSERT INTO players (player_id, last_name, name, number, position, team_id) VALUES (nextval('hibernate_sequence'), 'Kovacic', 'Mateo', 16, 'Centrocampista', 10);
INSERT INTO players (player_id, last_name, name, number, position, team_id) VALUES (nextval('hibernate_sequence'), 'Vazquez', 'Lucas', 17, 'Delantero', 10);
INSERT INTO players (player_id, last_name, name, number, position, team_id) VALUES (nextval('hibernate_sequence'), 'Modric', 'Luka', 19, 'Centrocampista', 10);
INSERT INTO players (player_id, last_name, name, number, position, team_id) VALUES (nextval('hibernate_sequence'), 'Isco', 'Alarcón', 22, 'Centrocampista', 10);
COMMIT ;
--
-- -- Create Statistics
...
-- VALUES (nextval('hibernate_sequence'), 'Camp Nou',11,10,1,1,null,to_date('12 03 2016 02:15:00', 'DD MM YYYY HH:MI:SS'));
--
...
145	Messi	Lionel	10	Delantero	11
146	Suarez	Luis	9	Delantero	11
147	da Silva	Neymar	11	Delantero	11
148	Stegen	Ter	1	Portero	11
149	Rakitic	Ivan	4	Centrocampista	11
150	Busquets	Sergio	5	Centrocampista	11
151	Gomes	Andres	21	Centrocampista	11
152	Piqué	Gerard	3	Defensa	11
153	Alba	Jordi	18	Defensa	11
154	Macherano	Javier	14	Defensa	11
155	Roberto	Sergi	20	Defensa	11
156	Navas	Keylor	1	Portero	10
157	Carvajal	Daniel	2	Defensa	10
158	Ramos	Sergio	4	Defensa	10
159	Varane	Raphael	5	Defensa	10
160	Ronaldo	Cristiano	7	Delantero	10
161	Benzema	Karin	9	Delantero	10
162	Vieira	Marcelo	12	Defensa	10
163	Kovacic	Mateo	16	Centrocampista	10
164	Vazquez	Lucas	17	Delantero	10
165	Modric	Luka	19	Centrocampista	10
166	Isco	Alarcón	22	Centrocampista	10
